...
const GalleryDotsHiddenClassName = 'gallery-dots-hidden';
...
class Gallery {
    ...
    constructor(element, options = {}) {
        ...
        this.settings = {
            ...
            speedTransition: options.speedTransition || '.25',
    ...
    manageHTML() {
        ...
        this.containerNode.innerHTML = `
            <div class="gallery-container-line">
        ...
        // Убираем точки если не нужны
        if (!this.settings.showDots) {
            this.dotsNode.classList.add(GalleryDotsHiddenClassName);
        }
    }
    ...
    setStyleTransition(countSwipes = 1) {
        this.lineNode.style.transition = `all ${countSwipes * this.settings.speedTransition}s ease 0s`
    }
